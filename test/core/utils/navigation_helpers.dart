...
Future<bool> _guardParental(
  ...
  if (unlocked) {
    // The initial blocked decision may still be cached for the same content.
    // Force a recompute so the destination page does not prompt for the PIN
    // again right after a successful unlock.
